...
def main():
    ...
    ax.scatter(R125.expt_rhoc, R125.expt_Tc, color="black", marker="x", linewidths=3, s=220, zorder=-1)
    ...
    fig.savefig("ffo_pdfs/vle-r125_prev.pdf")
    ...
    ax.text(0.6, 0.8, "HFC-125", fontsize=34, transform=ax.transAxes)
    fig.subplots_adjust(bottom=0.3, top=0.85, left=0.25, right=0.95)
    fig.savefig("ffo_pdfs/pvap-r125_prev.pdf")
    ...
    ax.text(0.6, 0.8, "HFC-125", fontsize=34, transform=ax.transAxes)
    fig.subplots_adjust(bottom=0.3, top=0.85, left=0.25, right=0.95)
    fig.savefig("ffo_pdfs/hvap-r125_prev.pdf")
