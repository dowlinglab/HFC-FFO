...
def main():
    ...
    ax.scatter(R32.expt_rhoc, R32.expt_Tc, color="black", marker="x", linewidths=3, s=300, zorder=-1)
    ...
    ax.legend(loc="lower left", bbox_to_anchor=(0.05, 1.0), ncol=2, fontsize=20, handletextpad=0.1, markerscale=0.8)
    fig.subplots_adjust(bottom=0.25, top=0.8, left=0.25, right=0.95)
    fig.savefig("ffo_pdfs/vle-r32_single.pdf")
    ...
    ax.text(0.65, 0.8, "HFC-32", fontsize=34, transform=ax.transAxes)
    fig.subplots_adjust(bottom=0.25, top=0.8, left=0.25, right=0.95)
    fig.savefig("ffo_pdfs/pvap-r32_single.pdf")
    ...
    ax.text(0.65, 0.8, "HFC-32", fontsize=34, transform=ax.transAxes)
    fig.subplots_adjust(bottom=0.25, top=0.8, left=0.25, right=0.95)
    fig.savefig("ffo_pdfs/hvap-r32_single.pdf")
