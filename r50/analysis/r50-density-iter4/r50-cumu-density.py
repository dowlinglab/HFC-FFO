...
liquid_density_threshold=200 #kg/m3
iternum = 4
...
dfs = [prepare_df_density(df_csv, R50, liquid_density_threshold)[0] for df_csv in df_csvs]
...
def main():
    ...
    dfs_paramsets = [prepare_df_density_errors(df, R50) for df in dfs]

    name = "mape_liq_density"
    fig, ax = plt.subplots()
    axins = inset_axes(ax, width="100%", height="100%",
            bbox_to_anchor=(0.6, 0.30, 0.25, 0.4),
    ...
    fig.tight_layout()
    fig.savefig("fig_r50-density-cumu.png",dpi=300)
