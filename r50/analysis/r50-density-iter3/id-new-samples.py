...
column_names = list(R50.param_names)
...
#distance_opt_v,number_points_v = bisection(lower_bound, upper_bound, error_tol, top_vap, R50, target_num_v, dist_seed)
#print('\nRequired Distance for vapor is : %0.8f and there are %0.1f points too few' % (distance_opt_v, number_points_v) )

distance_opt_l,number_points_l = bisection(lower_bound, upper_bound, error_tol, top_liq, R50, target_num_l, dist_seed)
print('\nRequired Distance for liquid is : %0.8f and there are %0.1f points too few' % (distance_opt_l, number_points_l) )

new_points_l = opt_dist(distance_opt_l, top_liq, R50, target_num_l, rand_seed=dist_seed , eval = True)
...
#new_points_v = opt_dist(distance_opt_v, top_vap, R50, target_num_v, rand_seed=dist_seed , eval = True)
