...
def main():
    ...
    for i in range(df_gaff["temperature"].shape[0]):
        ape=[]
        ape.append(np.abs(df_gaff["liq_density"][i]-R50.expt_liq_density[int(df_gaff["temperature"][i])])/R50.expt_liq_density[int(df_gaff["temperature"][i])])
    mape_gaff.append(np.mean(ape))
    for i in range(df_gaff["temperature"].shape[0]):
        ape=[]
        ape.append(np.abs(df_gaff["vap_density"][i]-R50.expt_vap_density[int(df_gaff["temperature"][i])])/R50.expt_vap_density[int(df_gaff["temperature"][i])])
    mape_gaff.append(np.mean(ape))
    for i in range(df_gaff["temperature"].shape[0]):
        ape=[]
        ape.append(np.abs(df_gaff["Pvap"][i]-R50.expt_Pvap[int(df_gaff["temperature"][i])])/R50.expt_Pvap[int(df_gaff["temperature"][i])])
    mape_gaff.append(np.mean(ape))
    for i in range(df_gaff["temperature"].shape[0]):
        ape=[]
    ...
    ax.plot(x_vals[-1], df_lit.loc["r50"][-1]/bounds[-1][1], markersize=12, color="#0989d9", marker="^", alpha=0.5, clip_on=False, zorder=200,label="Potoff et al.")
    ax.plot(x_vals[-2], df_lit.loc["r50"][-2]/bounds[-2][1], markersize=12, color="#0989d9", marker="^", alpha=0.5, clip_on=False, zorder=200)
    ax.plot(x_vals[-3], df_lit.loc["r50"][-3]/bounds[-3][1], markersize=12, color="#0989d9", marker="^", alpha=0.5, clip_on=False, zorder=200)
    ax.plot(x_vals[-4], df_lit.loc["r50"][-4]/bounds[-4][1], markersize=12, color="#0989d9", marker="^", alpha=0.5, clip_on=False, zorder=200)
    # Add TraPPE
    ax.plot(x_vals[-1], df_lit.loc["r50_trappe"][-1]/bounds[-1][1], markersize=12, color="red", marker="*", alpha=0.5, clip_on=False, zorder=200,label="TraPPE")
    ax.plot(x_vals[-2], df_lit.loc["r50_trappe"][-2]/bounds[-2][1], markersize=12, color="red", marker="*", alpha=0.5, clip_on=False, zorder=200)
    ax.plot(x_vals[-3], df_lit.loc["r50_trappe"][-3]/bounds[-3][1], markersize=12, color="red", marker="*", alpha=0.5, clip_on=False, zorder=200)
    ax.plot(x_vals[-4], df_lit.loc["r50_trappe"][-4]/bounds[-4][1], markersize=12, color="red", marker="*", alpha=0.5, clip_on=False, zorder=200)
