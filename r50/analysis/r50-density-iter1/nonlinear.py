...
out_top_vapor_csv_name = "r50-density-iter" + str(iternum ) + "-vapor-params.csv"
...
ranked_liquid_samples = rank_samples(liquid_samples, model, R50, "sim_liq_density")
ranked_vapor_samples = rank_samples(vapor_samples, model, R50, "sim_liq_density")#both l and g compared to liquid density
