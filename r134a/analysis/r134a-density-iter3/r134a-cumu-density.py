...
dfs = [prepare_df_density(df_csv, R134a, liquid_density_threshold)[0] for df_csv in df_csvs]
...
def main():
    ...
    dfs_paramsets = [prepare_df_density_errors(df, R134a) for df in dfs]
    ...
    ax.set_title(r"HFC-134a",fontsize=16)
    ...
    fig.tight_layout()
    fig.savefig("fig2_r134a-density-cumu.png",dpi=300)
