...
def main():
    ...
    r134a = pd.read_csv("../csv/r134a-pareto.csv",index_col=0)
    ...
    r134a_final = r134a_final[
                    (r134a_final["mape_Pvap"]<=2.5) &
                    (r134a_final["mape_Hvap"]<=2.5) &
                    (r134a_final["mape_liq_density"]<=2.5) &
                    (r134a_final["mape_vap_density"]<=2.5) &
                    (r134a_final["mape_Tc"]<=2.5) &
                    (r134a_final["mape_rhoc"]<=2.5)
    ]
   
    # Save CSV files
    #r32_final.to_csv("../csv/r32-final-4.csv")
    r134a_final.to_csv("../csv/r134a-final.csv")
