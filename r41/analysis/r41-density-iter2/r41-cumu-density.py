...
liquid_density_threshold=400 #kg/m3
iternum = 2
...
dfs = [prepare_df_density(df_csv, R41, liquid_density_threshold)[0] for df_csv in df_csvs]
...
def main():
    ...
    dfs_paramsets = [prepare_df_density_errors(df, R41) for df in dfs]
