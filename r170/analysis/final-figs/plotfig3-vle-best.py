...
def main():
    ...
    for temp in temps_r170:
        print(df_r170.loc[f"sim_liq_density_{float(temp):.0f}K"])
        ax2.scatter(
            df_r170.loc[f"sim_liq_density_{float(temp):.0f}K"],
            temp,
            c='blue',
            s=160,
            alpha=0.7,
        ...
        ax2.scatter(
            df_r170.loc[f"sim_vap_density_{float(temp):.0f}K"],
            temp,
            c='blue',
            s=160,
            alpha=0.7,
    ...
    tc, rhoc = calc_critical(df_r170_trappe)
    print("TraPPE: ", tc, " K ",rhoc)
    ax2.scatter(
        df_r170_trappe["liq_density"],
...
'''    # Plot Pvap / Hvap
    ...
    axs[0,1].text(0.5, 0.8, "HFC-170", fontsize=16, transform=axs[0,1].transAxes)
