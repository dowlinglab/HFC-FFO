...
distance_opt, number_points = bisection(lower_bound, upper_bound, error_tol, pareto_points, R170, target_num, dist_seed)
print('\nRequired Distance for vapor is : %0.8f and there are %0.1f points too few' % (distance_opt, number_points) )

new_points = opt_dist(distance_opt, pareto_points, R170, target_num, rand_seed=dist_seed , eval = True)
