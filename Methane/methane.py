...
class R125Constants:
    """Experimental data and other constants for Methane"""
    def __init__(self):
        assert (
    ...
    def expt_Pvap(self):
        ...
        expt_Pvap = {
            130: (367.32 * u.kPa).to_value(u.bar),
            140: (641.18 * u.kPa).to_value(u.bar),
            150: (1040.0 * u.kPa).to_value(u.bar),
            160: (1592.1 * u.kPa).to_value(u.bar),
            170: (2328.3 * u.kPa).to_value(u.bar),
        }
