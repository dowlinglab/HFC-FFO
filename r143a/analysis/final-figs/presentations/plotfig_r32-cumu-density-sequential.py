...
def main():
    ...
    fig.subplots_adjust(bottom=0.2, right=0.95, top=0.8)
    fig.savefig("ffo_pdfs/fig2-r32-cumu-LD1.pdf")
    ...
    fig.savefig("ffo_pdfs/fig2-r32-cumu-LD2.pdf")
    ...
    fig.savefig("ffo_pdfs/fig2-r32-cumu-LD3.pdf")
    ...
    ax.legend(fontsize=16, loc=(0.1,1.05), ncol=2, columnspacing=1, handletextpad=0.5)
    fig.savefig("ffo_pdfs/fig2-r32-cumu-LD4.pdf")
