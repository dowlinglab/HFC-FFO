...
liquid_density_threshold=1100 #kg/m3
iternum = 4
...
dfs = [prepare_df_density(df_csv, R14, liquid_density_threshold)[0] for df_csv in df_csvs]
...
def main():
    ...
    dfs_paramsets = [prepare_df_density_errors(df, R14) for df in dfs]
    ...
    fig.tight_layout()
    fig.savefig("fig2_r14-density-cumu.pdf")
