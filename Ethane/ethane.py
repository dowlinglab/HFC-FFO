...
class R125Constants:
    """Experimental data and other constants for Ethane"""
    def __init__(self):
        assert (
    ...
    def expt_Pvap(self):
        ...
        expt_Pvap = {
            210: (333.80 * u.kPa).to_value(u.bar),
            230: (700.18 * u.kPa).to_value(u.bar),
            250: (1300.8 * u.kPa).to_value(u.bar),
            270: (2210.0 * u.kPa).to_value(u.bar),
            290: (3515.9 * u.kPa).to_value(u.bar),
        }
